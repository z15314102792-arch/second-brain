---
name: 星月神殿
description: 星月神殿（双人闯关） — 废弃方案，代码保留在本地供参考
tags: [废弃方案]
metadata: 
  node_type: memory
  type: project
  status: 废弃方案
  path: E:\项目\star-moon-temple
  github: z15314102792-arch/star-moon-temple
  url: https://z15314102792-arch.github.io/star-moon-temple/
  version: v2.8
  modified: 2026-08-07T03:38:56.650Z
  originSessionId: 6dd31fbb-2c41-49f3-808f-f0380c8b1198
---

# 星月神殿（双人闯关）

**版本**: v2.8（⚠️ 之前记录为 v2.3，2026-08-07 发现代码实际为 v2.8）
**状态**: 🔘 废弃方案（2026-08-07）。代码保留在 `E:\项目\star-moon-temple`，不再维护。
